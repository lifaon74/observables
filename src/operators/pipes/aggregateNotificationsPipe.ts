 ...
 * @param inNames
 */
export function aggregateNotifications<TKeysIn extends string, TValue>(inNames: Iterable<TKeysIn> | null = null): IPipe<IObserver<INotification<TKeysIn, TValue>>, IObservable<TValue>> {
