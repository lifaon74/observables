...
function PureCompleteStateObservableFactory<TBase extends Constructor<INotificationsObservable<ICompleteStateObservableKeyValueMapGeneric<any>>>>(superClass: TBase) {
  type T = any;
  type TKVMap = ICompleteStateObservableKeyValueMapGeneric<T>;
...
export function CompleteStateObservableFactory<TBase extends Constructor<INotificationsObservable<ICompleteStateObservableKeyValueMapGeneric<any>>>>(superClass: TBase) {
...
export function CompleteStateObservableBaseFactory<TBase extends Constructor>(superClass: TBase) { // INotificationsObservableTypedConstructor<CompleteStateObservableKeyValueMapGeneric<any>>
  return MakeFactory<ICompleteStateObservableSoftConstructor, [
    INotificationsObservableTypedConstructor<ICompleteStateObservableKeyValueMapGeneric<any>>,
    IObservableConstructor
    ], TBase>(PureCompleteStateObservableFactory, [NotificationsObservableFactory, ObservableFactory], superClass, {
    name: 'CompleteStateObservable',
    instanceOf: CompleteStateObservable,
    waterMarks: [IS_COMPLETE_STATE_OBSERVABLE_CONSTRUCTOR],
  });
...
CompleteStateObservable = class CompleteStateObservable1 extends CompleteStateObservableBaseFactory<ObjectConstructor>(Object) {
  constructor(create?: (context: ICompleteStateObservableContext<any, ICompleteStateObservableKeyValueMapGeneric<any>>) => (IObservableHook<any> | void), options?: ICompleteStateObservableOptions) {
...
export class CompleteStateObservableContext<T, TKVMap extends CompleteStateKeyValueMapConstraint<T, TKVMap> = ICompleteStateObservableKeyValueMapGeneric<T>> extends NotificationsObservableContext<TKVMap> implements ICompleteStateObservableContext<T, TKVMap> {
