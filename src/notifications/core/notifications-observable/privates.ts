...
export interface INotificationsObservableInternal<TKVMap extends KeyValueMapGeneric> extends INotificationsObservablePrivatesInternal<TKVMap>, INotificationsObservable<TKVMap> {
}
