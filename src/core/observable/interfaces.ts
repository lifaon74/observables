...
export type TObservablePipeToObserverResult<TInputObserver extends IObserver<any>, TReferenceObserverValue> = UnionToIntersection<TInputObserver extends IObserver<infer T> ? T : never> extends UnionToIntersection<TReferenceObserverValue>
  ? TInputObserver
  : never;
...
export type TObservablePipeToCallbackResult<TInputCallback extends (value: any) => void, TReferenceObserverValue> = TInputCallback extends (value: infer T) => void
...
export type TObservablePipeThroughResult<TInputObservableObserver extends IObservableObserver<IObserver<any>, IObservable<any>>, TReferenceObserverValue> = TInputObservableObserver extends IObservableObserver<IObserver<infer T>, infer TObservable>
  ? UnionToIntersection<T> extends UnionToIntersection<TReferenceObserverValue>
    ? TObservable
    : never
  : never;
...
export type TObservablePipeResult<TInputObservableObserver extends IObservableObserver<IObserver<any>, IObservable<any>>, TReferenceObserverValue> = TInputObservableObserver extends IObservableObserver<IObserver<infer T>, IObservable<any>>
  ? UnionToIntersection<T> extends UnionToIntersection<TReferenceObserverValue>
